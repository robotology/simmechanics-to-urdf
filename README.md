...
| `frameName`       | String |  empty  | `displayName` of the frame in which the sensor measure is expressed. |
| `frame` | String | empty | It is the frame in which the forces and torques should be expressed. If empty, the child frame is used. |
